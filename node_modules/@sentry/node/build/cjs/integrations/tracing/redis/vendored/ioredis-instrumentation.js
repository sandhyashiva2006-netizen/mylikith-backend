  ...
  _patchSendCommand() {
    ...
    return (original) => {
      return function(...args) {
        ...
        const span = core.startInactiveSpan({ name: cmd.name, kind: core.SPAN_KIND.CLIENT, attributes });
        try {
  ...
  _patchConnection() {
    return (original) => {
      return function(...args) {
        ...
        const span = core.startInactiveSpan({ name: "connect", kind: core.SPAN_KIND.CLIENT, attributes });
        try {
          const result = original.apply(this, args);
